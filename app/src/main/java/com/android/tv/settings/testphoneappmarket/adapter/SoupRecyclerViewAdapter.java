...
public class SoupRecyclerViewAdapter extends RecyclerView.Adapter<SoupRecyclerViewAdapter.ItemViewHolder> implements OnMoveAndSwipedListener {
	SimpleItemsTouchHelper mItemsTouchHelper;
	private List<String>		mItems	= new ArrayList<>();
	private int mSweetFood[]={R.drawable.soup_one,R.drawable.soup_two,R.drawable.soup_three,R.drawable.soup_four,R.drawable.soup_five,R.drawable.soup_six,R.drawable.soup_six,R.drawable.soup_six,R.drawable.soup_six,R.drawable.soup_six};
	onStartDragListener			mOnStartDragListener;
	private static final String	TAG		= SoupRecyclerViewAdapter.class.getSimpleName();
	public SoupRecyclerViewAdapter(Context context, onStartDragListener onStartDragListener) {
		mItems.addAll(Arrays.asList(context.getResources().getStringArray(R.array.soup_items)));
