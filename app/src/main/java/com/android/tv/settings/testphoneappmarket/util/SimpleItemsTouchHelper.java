...
public class SimpleItemsTouchHelper extends ItemTouchHelper.Callback {
	...
	public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
		...
		if (actionState != ItemTouchHelper.ACTION_STATE_IDLE) {
			...
			if (viewHolder instanceof SweetRecyclerViewAdapter.onStateChangedListener) {
				SweetRecyclerViewAdapter.onStateChangedListener onStateChangedListener = (SweetRecyclerViewAdapter.onStateChangedListener) viewHolder;
